...
from metabolic_twin.config import MLP_RESULTS_TEMPLATE, RESULTS_DIR
...
def train_mlp(dataset_name='100k'):
    ...
    res.to_csv(RESULTS_DIR / MLP_RESULTS_TEMPLATE.format(dataset_name=dataset_name), index=False)
    return mlp
