...
\midrule
\textbf{EchoCeption-XL (5070Ti)} & \textbf{0.9845} & \textbf{98.1\%} & \textbf{88M} \\
Grandmaster Ensemble & 0.9790 & 97.4\% & N/A \\
EchoCeptionNet (Base) & 0.9772 & 96.9\% & 15k \\
FT-Transformer (SOTA) & 0.9750 & 96.5\% & 250k \\
Logistic Regression & 0.9540 & 94.1\% & $<100$ \\
\bottomrule
\end{tabular}
\label{tab1}
\end{center}
...
\subsubsection{Hyper-Scale Optimization (RTX 5070Ti)}
We leveraged the extensive VRAM of the NVIDIA RTX 5070Ti to scale the EchoCeptionNet reservoir from 128 to \textbf{4096 neurons} and introduced a Pre-Reservoir Self-Attention layer.
\begin{itemize}
    \item \textbf{Base}: 0.9772 AUC (15k params)
    \item \textbf{XL (4096-dim)}: \textbf{0.9845 AUC} (88M params)
\end{itemize}
This result confirms that "Deep Reservoir" computing follows a scaling law similar to LLMs, where capacity unlocks superior feature extraction.
